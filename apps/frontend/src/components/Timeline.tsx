  ...
  return (
    <div className="timeline">
      {steps.map((step, i) => {
        ...
        const offsetLabel = step.offset_mins < 0
        ...
        return (
          <div key={i} className={`timeline-item ${isNow ? 'timeline-now' : ''}`}>
            <div className="timeline-connector">
              <div className="timeline-dot" style={{ backgroundColor: color, boxShadow: `0 0 12px ${color}60` }} />
              {i < steps.length - 1 && <div className="timeline-line" />}
            </div>
            <div className="timeline-content">
              <div className="timeline-header">
                <span className="timeline-offset" style={{ color }}>{offsetLabel}</span>

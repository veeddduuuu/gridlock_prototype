      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 bg-transparent">
        <div className="w-full max-w-md space-y-8 animate-fade-in">
          ...
          <div className="flex flex-col items-center text-center space-y-2">
            ...
            <h1 className="text-3xl font-bold text-foreground">Fleet Dispatch</h1>
            <p className="text-muted-foreground text-sm">
              Sign in to access ETA-ranked field assignments
            </p>
          </div>
      ...
      <div className="hidden lg:flex lg:w-1/2 relative bg-gradient-to-br from-[#10b981]/20 via-[#10b981]/5 to-background overflow-hidden border-r border-border">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center w-full p-12 text-center">
          <div className="max-w-lg space-y-6">
            ...
            <h2 className="text-3xl font-bold text-foreground">Algorithmic Fleet Dispatch</h2>

            <p className="text-lg text-muted-foreground">
              Receive uncertainty-aware dispatch plans and algorithmically optimized barricade
              assignments generated by the 9-stage pipeline.
            </p>
            ...
            <div className="flex flex-col gap-4 pt-6 text-left w-full max-w-sm mx-auto">
              <div className="flex items-center gap-4 bg-background/60 p-4 rounded-xl border border-border">
                ...
                <div>
                  <h4 className="font-semibold text-sm">ETA-Ranked Dispatch</h4>
                  <p className="text-xs text-muted-foreground">
                    Assignments backed by Mappls Distance Matrix
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-background/60 p-4 rounded-xl border border-border">
                ...
                <div>
                  <h4 className="font-semibold text-sm">Optimal Choke Points</h4>
                  <p className="text-xs text-muted-foreground">
                    Severity-path blocking & perimeter rules
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 bg-background/60 p-4 rounded-xl border border-border">
                ...
                <div>
                  <h4 className="font-semibold text-sm">Accelerate Decay</h4>
                  <p className="text-xs text-muted-foreground">
                    1.5× congestion decay at assigned junctions
                  </p>
                </div>
              </div>
            </div>
